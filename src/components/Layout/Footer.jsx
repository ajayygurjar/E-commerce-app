        ...
        <Row className="d-flex justify-content-between align-items-center">
          ...
          <Col className="text-right">
            <div className="d-flex justify-content-end">
              ...
              <a href="https://www.spotify.com" target="_blank" rel="noopener noreferrer" className="text-white mx-3">
                <FaSpotify size={30} />
              </a>
              <a href="https://www.youtube.com" target="_blank" rel="noopener noreferrer" className="text-white mx-3">
                <FaYoutube size={30} />
              </a>
            </div>
          </Col>
